...
y_grid_cords = [779, 736, 639, 650, 607, 564, 521, 478, 435, 392, 349, 306, 263, 220, 177, 134, 91, 48, 5]

tetris_array = [[0] * 10] * 19
...
while run:
    ...
    pygame.draw.rect(main_window, (105, 105, 105), (5, 5, 433, 820))
    pygame.draw.rect(main_window, (192, 192, 192), (443, 5, 172, 820))
